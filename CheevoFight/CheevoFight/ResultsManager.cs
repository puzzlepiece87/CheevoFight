    ...
    public class ResultsManager : INotifyPropertyChanged
    {
        ...
        public int ProgressBarValue
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged(nameof(this.TextBlockContentTag));
            }
        }
        ...
        private string? textBlockContentTag;
        public string? TextBlockContentTag
        {
            get => this.textBlockContentTag;
            set
            {
                this.textBlockContentTag = value;
                this.NotifyPropertyChanged(nameof(this.TagTextBlockContent));
            }
        }
        public string TagTextBlockContent => this.TextBlockContentTag + ": " + this.ProgressBarValue.ToString() + "%";
