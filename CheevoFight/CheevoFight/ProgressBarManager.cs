    ...
    public class ProgressBarManager : INotifyPropertyChanged
    {
        ...
        public int ProgressBarValue
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged(nameof(this.LabelContent));
            }
        }
        ...
        private string? labelContentTask;
        public string? LabelContentTask
        {
            get => this.labelContentTask;
            set
            {
                this.labelContentTask = value;
                this.NotifyPropertyChanged(nameof(this.LabelContent));
            }
        }
        public string LabelContent => this.LabelContentTask + ": " + this.ProgressBarValue.ToString() + " / " + this.ProgressBarMaximum.ToString();
        ...
        /// <exception cref="ArgumentException">Thrown if no progress bar is found by that name</exception>
        public static void SetLabelContentTask(string progressBarName, string taskTextToDisplay)
        {
            if (!ProgressBarsByName.TryGetValue(progressBarName, out var progressBar))
            {
                throw new ArgumentException("No progress bar exists by name " + progressBarName);
            ...
            progressBar.LabelContentTask = taskTextToDisplay;
        }
    }
}
