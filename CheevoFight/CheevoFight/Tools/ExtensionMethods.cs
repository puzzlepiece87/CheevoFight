...
namespace CheevoFight.Tools
{
    internal static class ExtensionMethods
    {
        ...
        public static bool ContainsCaseInsensitive(this string entireString, string substring)
        {
            return entireString.Contains(substring, StringComparison.InvariantCultureIgnoreCase);
        }
